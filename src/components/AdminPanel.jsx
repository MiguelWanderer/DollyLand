...
function AdminPanel({ onClose }) {
  ...
  const signIn = async (event) => {
    ...
    setError('')
    if (!supabase) {
      setError('Falta configurar Supabase en las variables de producción de Vercel.')
      return
    }
